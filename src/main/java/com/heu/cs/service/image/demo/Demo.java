 ...
 */
package com.heu.cs.service.image.demo;
...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        int appId = 1252947691;//      YOUR_APPID
        String secretId = "AKIDgGajkbKhx64pQpF5xc5MQIyCIG6nRgst";
        String secretKey = "0qdHl9YpvrcCbeZJsLdjdLtFQPDpFW4S";
        
        // ImageClient
        ImageClient imageClient = new ImageClient(appId, secretId, secretKey);
        
        // 设置要操作的bucket
        String bucketName = "helpsendv1";
        String ret ;
...
//
        ...
        try {
            idcardNameList[0] = "face.jpg";
            idcardImageList[0] = CommonFileUtils.getFileContent("C:\\Users\\memgq\\Desktop\\porntest\\face.jpg");
            idcardNameList[1] = "face.jpg";
            idcardImageList[1] = CommonFileUtils.getFileContent("C:\\Users\\memgq\\Desktop\\porntest\\face.jpg");
        } catch (Exception ex) {
            Logger.getLogger(Demo.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            idcardImageList[0] = CommonFileUtils.getFileContent("C:\\Users\\memgq\\Desktop\\porntest\\back.jpg");
            idcardNameList[1] = "back.jpg";
            idcardImageList[1] = CommonFileUtils.getFileContent("C:\\Users\\memgq\\Desktop\\porntest\\back.jpg");
        } catch (Exception ex) {
            Logger.getLogger(Demo.class.getName()).log(Level.SEVERE, null, ex);
        }
