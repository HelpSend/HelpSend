...
public class CreateOrderDao {
    ...
    private final String PROJECT_URL = "http://123.207.138.180:7012";
    ...
    public ReturnInfoPojo insertOrder(String orderStr, String imagePath) {
        ...
        if (imagePath.equals(IMAGE_URL)) {
            order.setImagePath("http://123.207.138.180:7012/default/default.jpg");
        } else {
        ...
        try {
            ...
            returnInfoPojo.setMessage("下单成功");

        } catch (Exception exception) {
            exception.printStackTrace();
            returnInfoPojo.setStatus(operateFailure);
            returnInfoPojo.setMessage("下单失败");
        }finally {
